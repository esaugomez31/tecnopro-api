...
export const UserIDNotFoundError = ErrorFactory('User not found', 'The idUser could not be found in the system.')
export const UserActionNotAllowedError = ErrorFactory('Action not allowedd', 'The hierarchy of your users does not allow you to perform this action.')
