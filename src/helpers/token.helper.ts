...
export const generateAccessToken = (payload: IUserJWT): { token: string, expiresIn: number } => {
...
export const generateRefreshToken = (payload: IUserJWT): { token: string, expiresIn: number } => {
...
export const generateRefreshCookie = (refreshToken: string, expiresIn: number, res: Response): void => {
