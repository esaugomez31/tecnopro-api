...
routes.get(
  ...
  authenticationJWT,
  validateGetRoles(),
  checkPermission(page, RolePermEnum.VIEWLIST),
  roleGetAllController,
)
routes.get(
  "/:idRole",
...
routes.post(
  ...
  authenticationJWT,
  validateRoleCreation(),
  checkPermission(page, RolePermEnum.CREATE),
  roleCreateController,
)
routes.put(
  "/update/:idRole",
  authenticationJWT,
  validateRoleUpdate(),
  checkPermission(page, RolePermEnum.UPDATE),
  roleUpdateController,
)
routes.put(
  ...
  authenticationJWT,
  validateRoleUpdateStatus(),
  checkPermission(page, RolePermEnum.UPDATESTATUS),
  roleUpdateStatusController,
)
