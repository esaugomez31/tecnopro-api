...
routes.get(
  ...
  authenticationJWT,
  validateGetCategories(),
  checkPermission(page, CategoryPermEnum.VIEWLIST),
  categoryGetAllController,
)
routes.get(
  "/:idCategory",
...
routes.post(
  ...
  authenticationJWT,
  validateCategoryCreation(),
  checkPermission(page, CategoryPermEnum.CREATE),
  categoryCreateController,
)
routes.put(
  "/update/:idCategory",
  authenticationJWT,
  validateCategoryUpdate(),
  checkPermission(page, CategoryPermEnum.UPDATE),
  categoryUpdateController,
)
routes.put(
  "/:idCategory/status/:status",
  authenticationJWT,
  validateCategoryUpdateStatus(),
  checkPermission(page, CategoryPermEnum.UPDATESTATUS),
  categoryUpdateStatusController,
)
