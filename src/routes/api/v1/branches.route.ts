...
routes.post(
  ...
  authenticationJWT,
  validateBranchCreation(),
  checkPermission(page, BranchPermEnum.CREATE),
  branchCreateController,
)
routes.put(
  "/update/:idBranch",
  authenticationJWT,
  validateBranchUpdate(),
  checkPermission(page, BranchPermEnum.UPDATE),
  branchUpdateController,
)
routes.put(
  "/:idBranch/status/:status",
  authenticationJWT,
  validateBranchUpdateStatus(),
  checkPermission(page, BranchPermEnum.UPDATESTATUS),
  branchUpdateStatusController,
)
