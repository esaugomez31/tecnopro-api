...
routes.get(
  ...
  authenticationJWT,
  validateGetProducts(),
  checkPermission(page, ProductPermEnum.VIEWLIST),
  productGetAllController,
)
routes.get(
  "/:idProduct",
...
routes.post(
  ...
  authenticationJWT,
  validateProductCreation(),
  checkPermission(page, ProductPermEnum.CREATE),
  productCreateController,
)
routes.put(
  "/update/:idProduct",
  authenticationJWT,
  validateProductUpdate(),
  checkPermission(page, ProductPermEnum.UPDATE),
  productUpdateController,
)
routes.put(
  ...
  authenticationJWT,
  validateProductUpdateStatus(),
  checkPermission(page, ProductPermEnum.UPDATESTATUS),
  productUpdateStatusController,
)
